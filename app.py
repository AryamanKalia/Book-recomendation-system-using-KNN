...
class Books:
    def __init__(self):
        self.books = pd.read_csv(r'C:\Users\Aryaman kalia\Desktop\book-recommendation-system-webapp-master/Book/Books.csv')
        self.users = pd.read_csv(r'C:\Users\Aryaman kalia\Desktop\book-recommendation-system-webapp-master/Book/Users.csv')
        self.ratings = pd.read_csv(r'C:\Users\Aryaman kalia\Desktop\book-recommendation-system-webapp-master/Book/Ratings.csv')
